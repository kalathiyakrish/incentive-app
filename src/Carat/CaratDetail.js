...
const CaratDetail = () => {
  ...
  useEffect(() => {
    if (state?.salary && state?.gram) {
      ...
      if (salary === 20000) {
        if (CT <= 10000) {
          RATE = 10 * Math.floor((CT - 1) / 250) + 20;
        } else {
          RATE = 0;
        }
        ...
        if (CT <= 750) {
          ...
          RATE = 10 * Math.floor((CT - 751) / 250) + 10;
        } else {
          RATE = 0;
        }
        ...
        if (CT <= 1250) {
          ...
          RATE = 10 * Math.floor((CT - 1251) / 250) + 10;
        } else {
          RATE = 0;
        }
        ...
        if (CT <= 1750) {
          ...
          RATE = 10 * Math.floor((CT - 1751) / 250) + 10;
        } else {
          RATE = 0;
        }
        ...
        if (CT <= 2250) {
          ...
          RATE = 10 * Math.floor((CT - 2251) / 250) + 10;
        } else {
          RATE = 0;
        }
        ...
        if (CT <= 2500) {
          ...
          RATE = 10 * Math.floor((CT - 2751) / 250) + 10;
        } else {
          RATE = 0;
        }
        ...
        if (CT <= 3000) {
          ...
          RATE = 10 * Math.floor((CT - 3251) / 250) + 10;
        } else {
          RATE = 0;
        }
      } else {
