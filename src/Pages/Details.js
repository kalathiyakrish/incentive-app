...
const Details = () => {
  ...
  useEffect(() => {
    if (state?.salary && state?.gram) {
      ...
      // ins = gram > 100000 ? 20.5 : Math.floor(gram / 2500) * 1;        USING TERNARY OPERATOR
      //  ins = gram > 100000 ? 20.5 : Math.ceil(gram / 2500) * 0.5;

      if (salary <= 35000) {
        if (gram <= 35000) {
          ins = 0;
        } else if (gram >= 35000 && gram < 37500) {
          ins = 2.5;
        } else if (gram >= 37500 && gram < 40000) {
          ins = 3;
        } else if (gram >= 40000 && gram < 42500) {
          ins = 2;
        } else if (gram >= 42500 && gram < 45000) {
          ins = 2.5;
        } else if (gram >= 45000 && gram < 47500) {
          ins = 3;
        } else if (gram >= 47500 && gram < 50000) {
          ins = 3.5;
        } else if (gram >= 50000 && gram < 52500) {
          ins = 4;
        } else if (gram >= 52500 && gram < 55000) {
          ins = 4.5;
        } else if (gram >= 55000 && gram < 57500) {
          ins = 5;
        } else if (gram >= 57500 && gram < 60000) {
          ins = 5.5;
        } else if (gram >= 60000 && gram < 62500) {
          ins = 6;
        } else if (gram >= 62500 && gram < 65000) {
          ins = 6.5;
        } else if (gram >= 65000 && gram < 67500) {
          ins = 7;
        } else if (gram >= 67500 && gram < 70000) {
          ins = 7.5;
        } else if (gram >= 70000 && gram < 72500) {
          ins = 8;
        } else if (gram >= 72500 && gram < 75000) {
          ins = 8.5;
        } else if (gram >= 75000 && gram < 77500) {
          ins = 9;
        } else if (gram >= 77500 && gram < 80000) {
          ins = 9.5;
        } else if (gram >= 80000 && gram < 82500) {
          ins = 10;
        } else if (gram >= 82500 && gram < 85000) {
          ins = 10.5;
        } else if (gram >= 85000 && gram < 87500) {
          ins = 11;
        } else if (gram >= 87500 && gram < 90000) {
          ins = 11.5;
        } else if (gram >= 90000 && gram < 92500) {
          ins = 12;
        } else if (gram >= 92500 && gram < 95000) {
          ins = 12.5;
        } else if (gram >= 95000 && gram < 97500) {
          ins = 13;
        } else if (gram >= 97500 && gram < 100000) {
          ins = 13.5;
        } else {
          ins = 0;
        }
      ...
      if (gram > 100000) {
        ...
        // else if (salary <= 35000) base = 40000;
        else base = Infinity; // salary too high, no incentive
